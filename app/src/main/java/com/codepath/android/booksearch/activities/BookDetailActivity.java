...
public class BookDetailActivity extends AppCompatActivity {
    ...
    public Uri getBitmapFromDrawable(Bitmap bmp){
        ...
        try {
            ...
            bmpUri = FileProvider.getUriForFile(BookDetailActivity.this, "com.codepath.android.booksearch.Details", file);  // use this version for API >= 24
